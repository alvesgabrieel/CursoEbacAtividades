...
form.addEventListener('submit', function(e){
    ...
    if(numeroA < numeroB) {
        ...
        containerMsg.style.background = 'green';

    } else {
        let containerMsg = document.querySelector('.msg-retorno');
        containerMsg.innerHTML = msgErro;
        containerMsg.style.display = 'block';
        containerMsg.style.background = 'red';
    }
    var numeroA1 = document.getElementById('campoA');
    numeroA1.value = '';
    var numeroB1 = document.getElementById('campoB');
    numeroB1.value = '';
})
